...
| frontend-qa-tester | Frontend QA and regression testing specialist | Test frontend flows, E2E coverage, accessibility verification |
...
# ECC for Codex CLI (Codex-Specific Guidance)

This section supplements the global ECC instructions with Codex-specific guidance.
