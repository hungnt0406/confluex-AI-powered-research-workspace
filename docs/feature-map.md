...
| Project and admin token usage telemetry | `backend/services/ai_usage.py`, `backend/services/llm.py`, `backend/services/embeddings.py`, `backend/api/routers/projects.py`, `backend/api/routers/admin.py`, `backend/api/schemas/projects.py`, `backend/api/schemas/admin.py`, `backend/db/models.py`, `frontend/app/admin/usage/page.tsx`, `frontend/components/Sidebar.tsx`, `frontend/lib/api.ts` | `tests/test_llm_embeddings.py`, `tests/test_projects.py`, `tests/test_admin.py` | `README.md`, `docs/feature-map.md` | `database_schema.sql`, `backend/db/migrations/versions/20260426_01_ai_usage_events.py`, `OPENROUTER_API_KEY`, `ADMIN_EMAILS` |
