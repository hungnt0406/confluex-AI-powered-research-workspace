...
Next.js 14 App Router chat UI for the Automated Literature Review FastAPI backend. Implements the **Evergreen Stewardship** design system from `ui_design_chat_page/DESIGN.md`.
...
- `app/layout.tsx`, `app/globals.css`, `tailwind.config.ts` — design tokens from `DESIGN.md`.
...
- `components/Sidebar.tsx`, `components/ChatWorkspace.tsx`, `components/ContextPanel.tsx` — UI panels from the HTML mock.
